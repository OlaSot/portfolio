...
const projects: Project[] = [
  {
    ...
    description: "Complete brand identity for luxury skincare line including logo, packaging, and digital presence.",
  ...
  },
  {
    ...
    description: "Cargo Service Berlin specializes in providing high-quality services in the field of air and land freight transport to the CIS countries. The company places great importance on fast and secure delivery of goods and offers reliable as well as efficient logistics solutions for its customers",
  ...
  },
  {
    ...
    description: "Brand identity and packaging design for local coffee roastery with sustainable focus.",
  ...
  },
  {
    ...
    description: "Interactive portfolio website with custom animations and scroll-triggered effects.",
  ...
  },
  {
    ...
    title: "Mainwest",
    category: ["branding"],
    description: "A unique transformer bag, which is allowed for most airlines, it is forbidden to take it into the cabin. It solves the problem of those who do not have a car, but have a bicycle. It unfolds so that there is maximum comfort",
    image: "/images/Mainwest.png",
    technologies: ["Adobe Illustrator", "InDesign", "Photoshop", "After Effects"],
  ...
  },
  {
    ...
    description: "Clean and intuitive dashboard design for e-commerce analytics platform.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-6xl font-bold text-gray-800 mb-6">
            Selected <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Works</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            A curated selection of projects that showcase my passion for creating meaningful digital experiences.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {selectedProject.technologies.map((tech) => (
                      <span key={tech} className="px-4 py-2 bg-purple-100 text-purple-600 font-medium rounded-full">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <button className="hoverable bg-purple-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:bg-purple-700 hover:shadow-lg">
                  View Live Project
                </button>
              </div>
            </div>
